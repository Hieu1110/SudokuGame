...
public class ServerThread implements Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            Server.serverview.setnotify("Mot nguoi choi vua đang nhap , ID la: " + clientNumber);
            ...
            while (!isClosed) {
                ...
                if (messageSplit[0].equals("create-room")) {
                    Server.serverview.setnotify("Đa tao phong moi!");
            ...
            Server.serverview.setnotify("Nguoi choi co ID " + this.clientNumber + " da thoat");

            System.out.println(this.clientNumber + " đa thoat");
        }
    }
